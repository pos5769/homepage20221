...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#deleteBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#insertBBSMastetInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#selectBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#selectBBSMasterInfs(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#updateBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see egovframework.let.cop.bbs.CRUDService.service.EgovBBSAttributeManageService#validateTemplate(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
